...
export default function page() {
  return (
    <div>
        <Bgstructure title="About Us" src="/aboutus.jpg"/>
        <Box>
        <Container maxW={1400}>
          <Flex my='50px' px={{ lg: '50px', base: '20px' }} gap='30px' display={{ lg: 'flex', base: 'grid' }}>
            ...
            <Box flexBasis='50%'>
              <RevealList interval={60} delay={500} origin='right' duration={1000} distance='500px' reset={true} >
                <Heading borderStartWidth={'10px'} pl='10px' borderLeftColor='red.300' size='2xl'>Dr. Arif Alvi</Heading>
                ...
                <Button colorScheme='red' mt={5} size='md'>More Info</Button>
              </RevealList>
            </Box>
          </Flex>
        </Container>
          ...
          <Flex my='50px' px={{ lg: '50px', base: '20px' }} gap='30px' display={{ lg: 'flex', base: 'grid' }}>
            <Box flexBasis='50%'>
              <RevealList interval={60} delay={500} origin='left' duration={1000} distance='500px' reset={true} >
                <Heading borderStartWidth={'10px'} pl='10px' borderLeftColor='red.300' size='2xl'>Panaverse DAO</Heading>
      ...
      <Box>
        <Container maxW={1400}>
          <Flex my='50px' px={{ lg: '50px', base: '20px' }} gap='30px' display={{ lg: 'flex', base: 'grid' }}>
            ...
            <Box flexBasis='50%'>
              <RevealList interval={60} delay={500} origin='right' duration={1000} distance='500px' reset={true} >
                <Heading borderStartWidth={'10px'} pl='10px' borderLeftColor='red.300' size='2xl'>Zia Khan</Heading>
